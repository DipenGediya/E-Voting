...
import {delete_election, delete_party, delete_partyConnection, delete_user, get_election, get_party, get_partyConnection, get_user, get_vote, post_election, post_party, post_partyConnection, post_user, post_vote } from "../../admin/api"
import { DELETE_ELECTION_ERROR, DELETE_ELECTION_SUCCESS, DELETE_PARTY_CONNECTION_ERROR, DELETE_PARTY_CONNECTION_SUCCESS, DELETE_PARTY_ERROR, DELETE_PARTY_SUCCESS, DELETE_USER_ERROR, DELETE_USER_SUCCESS, GET_ELECTION_ERROR, GET_ELECTION_SUCCESS, GET_PARTY_CONNECTION_ERROR, GET_PARTY_CONNECTION_SUCCESS, GET_PARTY_ERROR, GET_PARTY_SUCCESS, GET_USER_ERROR, GET_USER_SUCCESS, GET_VOTE_ERROR, GET_VOTE_SUCCESS, POST_ELECTION_ERROR, POST_ELECTION_SUCCESS, POST_PARTY_CONNECTION_ERROR, POST_PARTY_CONNECTION_SUCCESS, POST_PARTY_ERROR, POST_PARTY_SUCCESS, POST_USER_ERROR, POST_USER_SUCCESS, POST_VOTE_ERROR, POST_VOTE_PENDING } from "../../admin/action"
...
function* handle_get_vote(action) {
    try {
        ...
        yield put({type:GET_VOTE_SUCCESS,payload:data})
    } catch (error) {
...
function* handle_post_vote(action) {
    try {
        ...
        yield put({type:POST_VOTE_PENDING,payload:data});
    } catch (error) {
        yield put({type:POST_VOTE_ERROR,payload:error});
    }
}

export { handle_get_party, handle_post_party, handle_delete_party, handle_get_user, handle_post_user, handle_delete_user, handle_get_election, handle_post_election, handle_delete_election, handle_get_partyConnection,handle_post_partyConnection ,handle_delete_partyConnection , handle_get_vote ,handle_post_vote}